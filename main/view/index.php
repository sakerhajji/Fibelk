          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  <div class="price">
                    <span><?php echo $cinema['IdCinema']; ?></span>
                  </div>
                 <!-- <a href="meeting-details.html">-->
                  <a href="#"></a><img src="src/<?=$cinema['ImageCine'];?>"alt="New Lecturer Meeting"></a>
                </div>
                <div class="down-content">
                  <div class="date">
                    <h6>Nombre des places <span><?= $cinema['NbrPlaceSalleCin']; ?></span></h6>
                  </div>
                  <a href="#"><h4> <?= $cinema['NomCin']; ?></h4></a>
                  <p>Nombre des salles <?= $cinema['NbrSalleCin']; ?></p>
                </div>
              </div>
            </div>
            <?php
