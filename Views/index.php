          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  <div class="price">
                    <span> <?= $piece['id_p']; ?></span>
                  </div>
                 <!-- <a href="meeting-details.html">--><a href="#"></a><img src="src/<?= $piece['image_p']; ?>" height="300px" alt="New Lecturer Meeting"></a>
                </div>
                <div class="down-content">
                  <div class="date">
                    <h6>Durée <span><h4><?= $piece['duree_p']; ?></h4></span></h6>
                  </div>
                  <a href="#"><h4> <?= $piece['nom_p']; ?></h4></a>
                  <p> <?= $piece['description_p']; ?></p>
                </div>
              </div>
            </div>
            <?php 
            ...
            <!--<div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="#"><img src="src/<?= $piece['image_p']; ?>" height="300px" alt="Online Teaching"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="#"><img src="src/<?= $piece['image_p']; ?>" height="300px" alt="Higher Education"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="#"><img src="src/<?= $piece['image_p']; ?>" height="300px" alt="Student Training"></a>
                </div>
                <div class="down-content">
                  <div class="date">
