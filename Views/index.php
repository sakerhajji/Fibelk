          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <div class="caption">
              <h2>Fibelik?</h2>
              <h6>Fibelik est ub site web tunisien qui propose une diversité d'informations <br> sur les événements culturels, sportifs et autres.</h6>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  <div class="price">
                    <span><?php echo $lieu_match['id_LM']; ?></span>
                  </div>
                 <!-- <a href="meeting-details.html">--><a href="#"></a><img src="src/<?= $lieu_match['image_T']; ?>"  alt="New Lecturer Meeting"></a>
                </div>
                <div class="down-content">
                  <div class="date">
                    <h6>Capacité <span><?php echo $lieu_match['capacite']; ?></span></h6>
                  </div>
                  <a href="#"><h4> <?php echo $lieu_match['nom_LM']; ?></h4></a>
                  <p> <?php echo $lieu_match['description']; ?></p>
                </div>
              </div>
            </div>
            <?php
           ...
           <!-- <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="#"><h4>Selim Arjoon Et Nour Arjoon en tournée exclusive</h4></a>
                  <p>Les deux artistes commenceront bientot leur tourée dans les différents gouvernerats de la Tunisie.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="#"><h4>Amphitheatre de Carthage</h4></a>
                  <p>Le festival de Carthage présentera une variété de spectacles <br>pour tous les gouts.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="#"><h4>La foire du livre</h4></a>
