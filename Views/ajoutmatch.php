    ...
    <div class="container">
        ...
        <form action="#">
            ...
            <div class="form-row">
                ...
                <div class="input-data">
                    <input type="time" id="temp_o" name="temp_O_T" value="<?php echo $p['temp_O_T'];?>" required>
                    <div class="underline"></div>
            ...
            <div class="form-row">
                <div class="input-data">
                    <input type="time" id="temp_f" name="temp_F_T" value="<?php echo $p['temp_F_T'];?>" required>
                    <div class="underline"></div>
            ...
            <div class="form-row">
                <div class="input-data">
                    <input textarea id="description" name="description" value="<?php echo $p['description_M'];?>"
                        required>
                    <div class="underline"></div>
