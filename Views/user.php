...
$userc = new Userc();
$admin = new Userc();
$numbreAdmin = new Userc(); 
$list = $userc->listusers();
$list1 = $admin->listAdmin();
$x=$numbreAdmin->CountAdmin() ;  
$y=$numbreAdmin->Countusers() ; 
$z=$numbreAdmin->Countall() ; 
		...
		<main>
			...
			<ul class="box-info">
				...
				<li>
					...
					<span class="text">
						<h3><?= $z; ?></h3>
						<p>nombres d'utlisateurs total </p>
					</span>
				</li>
			</ul>
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						...
						<form action="#">
				<div class="form-input">
					<input type="search" placeholder="Search..." style="background: var(--light); border: none;">
					<button type="submit" class="search-btn" style="background-color: transparent;  border: none;" ><i class='bx bx-search' ></i></button>
				</div>
			</form>
