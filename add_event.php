    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="box-infos1" id="theatre_event" style="display:none;">
                ...
                <li>
                    <button style=" background-color: transparent;  border: none;" onclick="showFormtheatre()">
                        <i class='bx bxs-data'></i>
                    </button>
                    <span class="text">
                        <h3>Ajouter event detailles </h3>
...
//if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(
      ...
      isset($_GET['id_LC'])&&isset($_GET['nom_LC'])
...
?>
            ...
            <div class="container" id="concert" style="display:none;">
                ...
                <div class="card" id="pup">
                    ...
                    <form id="myForm" id="myForm" onsubmit="return validateForm()" action="#">
                        <div class="form-row">
                            <div class="input-data">
                                <input type="text" name="id_LC" id='id_LC' required>
                                <!--fi kol input hot name o id kima esemi base-->
                                <div class="underline"></div>
                                <label for="">ID lieu concert</label>
                            </div>
                            <div class="input-data">
                                <input type="text" name="nom_LC" id='nom_LC' required>
                                <div class="underline"></div>
                        ...
                        <div class="form-row">
                            <div class="input-data">
                                ...
                                <input type="time" name="temp_O_LC" id='temp_O_LC' required
                            ...
                            <div class="input-data">
                                ...
                                <input type="time" name="temp_F_LC" id='temp_F_LC' required>
                                <div class="underline"></div>
            ...
            function validateForm() {
                var id_LC = document.forms["myForm"]["id_LC"].value;
                var nom_LC = document.forms["myForm"]["nom_LC"].value;
                var adresse = document.forms["myForm"]["adresse"].value;

                if (nom_LC == "") {
                    alert("Name must be filled out");
                    return false;
                } else if (/[/,*,-,_]/.test(nom_LC)) {
                ...
                if (adresse == "") {
                    ...
                    return false;
                } else if (/[A-Z]/.test(adresse)) {
                    alert("Adresse must not contain uppercase letters");
                    return false;
                }
            }
            </script>
            ...
            <div class="container" id="theatre" style="display:none;">
